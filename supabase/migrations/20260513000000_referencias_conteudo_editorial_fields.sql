...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE conname = 'chk_promoted_requires_editorial_fields'
      AND conrelid = 'referencias_conteudo'::regclass
  ) THEN
    ALTER TABLE referencias_conteudo
